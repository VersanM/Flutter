...
import 'package:trivia_tdd_clean_architecture/core/util/input_converter.dart';
import 'package:trivia_tdd_clean_architecture/features/number_trivia/domain/entities/number_trivia.dart';
import 'package:trivia_tdd_clean_architecture/features/number_trivia/domain/usecases/get_concrete_number_trivia.dart';
import 'package:trivia_tdd_clean_architecture/features/number_trivia/domain/usecases/get_random_number_trivia.dart';
...
void main() {
  ...
  group('GetTriviaForConcreteNumber', () {
    ...
    test(
      'should emit [Loading, Error] with proper message fot the error when getting data fails',
      () async* {
        // arrange
        setUpMockInputConverterSuccess();
        when(mockGetConcreteNumberTrivia(any))
